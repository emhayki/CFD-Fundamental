...
int main() {
    ...
    const int X = 101;                        // Number of points along X-axis
    const int Y = 101;                        // Number of points along Y-axis
    const int T = 80;                         // Total number of time steps
    ...
    for (int n = 0; n < T; n++) {
        ...
        // Boundary conditions
        for (int i = 0; i < X; i++){u[i][0] = 1.;  v[i][0] = 1.;}
        for (int i = 0; i < Y; i++){u[0][i] = 1.;  v[0][i] = 1.;}

        for (int i = 0; i < X; i++){u[i][Y-1] = 1.; v[i][Y-1] = 1.;}
        for (int i = 0; i < Y; i++){u[X-1][i] = 1.; v[X-1][i] = 1.;}
